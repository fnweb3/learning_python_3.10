...
variable_entera = 75
variable_flotante = 15.25
variable_cadena = "Hola Mundo"
variable_booleana = True

# completa los valores de las variables de acuerdo a su tipo
# ... (ahora podes seguir con el código....)
print ("Valor de la variable entera = ", variable_entera)
print ("Valor de la variable flotante = ", variable_flotante)
print ("Valor de la variable cadena = ", variable_cadena)
print ("Valor de la variable booleana = ", variable_booleana)